...
const HeroCard: React.FC<MyComponentProps> = ({heading, description }) => {
    return <div className='bg-white w-40 h-25 p-2 md:px-4 md:h-40 md:w-80 border-2 shadow-lg border-neutral-300 hover:bg-gray-600 hover:text-white rounded-xl mx-4 md:mx-9 flex flex-col justify-center items-start transition-colors delay-50 duration-200'>
