...
export default function Thirdpage() {
    ...
    return <div id="third-page" className="md:pt-8 h-full w-full flex flex-col justify-center items-center md:justify-start">
        ...
        <div id="third-page" className='w-full bg-gradient-to-r from-stone-400 to-stone-500 my-4'>
...
const HeroCard: React.FC<MyComponentProps> = ({heading, description }) => {
    return <div className='bg-white w-40 h-25 p-2 md:px-4 md:h-40 md:w-80 shadow-lg hover:bg-stone-600 hover:text-white rounded-xl mx-4 md:mx-9 flex flex-col justify-center items-start transition-colors delay-50 duration-200'>
